...
public class Token extends Model {
     ...
     *
     * @param usuario the current usuario
     * @throws java.net.MalformedURLException if token is wrong.
     */
    public void sendMailResetPassword(Usuario usuario, MailerClient mc) throws MalformedURLException {
        sendMail(usuario, TypeToken.password, null, mc);
    }
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    public void sendMailChangeMail(Usuario usuario, @Nullable String email, MailerClient mc) throws MalformedURLException {
        sendMail(usuario, TypeToken.email, email,mc );
    }
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    private void sendMail(Usuario usuario, TypeToken type, String email, MailerClient mc) throws MalformedURLException {
